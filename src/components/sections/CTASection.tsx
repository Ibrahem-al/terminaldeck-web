    ...
    <section id="download" className="relative py-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-8 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <a href={DOWNLOADS.windows} className="flex items-center gap-3 px-10 py-4 rounded-xl font-semibold text-lg text-void bg-cyan hover:brightness-110 transition-all glow-box">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801" />
            </svg>
            Download for Windows
          </a>
          <a href={DOWNLOADS.windowsGuide} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-10 py-4 rounded-xl font-semibold text-lg text-text-mid border border-border hover:border-cyan/30 hover:text-text transition-all">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801" />
            </svg>
            Windows — Build Guide
          </a>
          <a href={DOWNLOADS.macos} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-10 py-4 rounded-xl font-semibold text-lg text-text-mid border border-border hover:border-cyan/30 hover:text-text transition-all">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
