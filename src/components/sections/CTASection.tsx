    ...
    <section id="download" className="relative py-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-8 text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }}
          ...
          <a href={DOWNLOADS.macos} className="flex items-center gap-3 px-10 py-4 rounded-xl font-semibold text-lg text-text-mid border border-border hover:border-cyan/30 hover:text-text transition-all">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
